...
class Feature:
    ...
    def loadSuperpixelImage(self):
        ...
        #1000, 3
        self.im_sp = sl.getSlicSuperpixels(self.im, 1000, 3, True)
    ...
    def getFeaturesVectors(self):
        ...
        # basic feature vector with only color
        #self.featureVectors = np.vstack((self.sp_color.T)).T

        # basic feature vector with color & location
